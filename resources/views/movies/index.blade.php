...
<div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
    ...
    <div class="bg-white p-4 rounded-xl shadow hover:shadow-lg transition">
        <h2 class="text-xl font-bold mb-1">{{ $movie->movie_title }}</h2>
        ...
        <div class="mt-4 flex justify-between gap-2">
            ...
            <a href="{{ route('movies.tickets', $movie->id) }}" class="bg-gray-300 hover:bg-gray-400 px-3 py-1 rounded shadow">View Details</a>
        </div>
    </div>
    @endforeach
</div>
